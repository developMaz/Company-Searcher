 ...
 * 2019-05-22T06:45:13.294+02:00
 * Generated source version: 3.3.2
 *
 */
@WebServiceClient(name = "UslugaBIRzewnPubl",
                  wsdlLocation = "file:/D:/JAVA/Obsydian/companySearcherApp/src/main/resources/UslugaBIRzewnPubl.xsd",
...
public class UslugaBIRzewnPubl extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/D:/JAVA/Obsydian/companySearcherApp/src/main/resources/UslugaBIRzewnPubl.xsd");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UslugaBIRzewnPubl.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/D:/JAVA/Obsydian/companySearcherApp/src/main/resources/UslugaBIRzewnPubl.xsd");
        }
        WSDL_LOCATION = url;
    }
